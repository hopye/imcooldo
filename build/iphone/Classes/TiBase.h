...
// in simulator we redefine to format for imcooldo Developer console
...
{\
	NSString * exceptionName = [@"org.imcooldo." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.imcooldo";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIimcooldoNativeItemNone = -1, 
	UIimcooldoNativeItemSpinner = -2,
	UIimcooldoNativeItemProgressBar = -3,
	
	UIimcooldoNativeItemSlider = -4,
	UIimcooldoNativeItemSwitch = -5,
	UIimcooldoNativeItemMultiButton = -6,
	UIimcooldoNativeItemSegmented = -7,
	
	UIimcooldoNativeItemTextView = -8,
	UIimcooldoNativeItemTextField = -9,
	UIimcooldoNativeItemSearchBar = -10,
	
	UIimcooldoNativeItemPicker = -11,
	UIimcooldoNativeItemDatePicker = -12,
	
	UIimcooldoNativeItemInfoLight = -13,
	UIimcooldoNativeItemInfoDark = -14,
	
	UIimcooldoNativeItemDisclosure = -15,
	
	UIimcooldoNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all imcooldo instances of
