...
//@interface imcooldoObject : NSObject
//@end

@interface imcooldoObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[imcooldoObject class]])
		{
			for (NSString *key in [[(imcooldoObject*)o modules] allKeys])
			{
